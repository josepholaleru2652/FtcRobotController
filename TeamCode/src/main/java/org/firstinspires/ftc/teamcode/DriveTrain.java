...
public class DriveTrain extends OpMode {
    ...
    public void loop() {   
        ...
        // so right now the right stick is controlling the front and back power of all the motors
        // its negative y because for example if the left wheels move clockwise(+) then its backwards so it needs counterclockwise(-)
